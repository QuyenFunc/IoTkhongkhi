...
String  EfirebaseHost = "";           // EEPROM Firebase Host
String  EfirebaseAuth = "";           // EEPROM Firebase API Key
String  EuserUID = "";                // EEPROM User UID  
String  EuserKey = "";                // EEPROM User Key for device pairing
